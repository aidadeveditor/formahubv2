...
QUIZ["excel-analyse-donnees/module-1"] = {
 ...
 "questions": [
  {"id":"q1","question":"Une colonne de montants apparaît alignée à gauche dans un fichier reçu. Qu'est-ce que cela indique ?",
   "choices":[{"key":"a","text":"Une simple préférence de mise en forme, sans conséquence"},
              {"key":"b","text":"Que les valeurs sont stockées en texte : toute somme les comptera pour zéro"},
              {"key":"c","text":"Que la colonne contient des valeurs négatives"}],
   "correct_answer":"b","feedback":"Sans formatage explicite, Excel aligne nombres et dates à droite, le texte à gauche. Le danger est le typage mixte : la somme renvoie alors un total partiel, plausible et faux."},
  ...
  {"id":"q3","question":"Quel est le premier geste après avoir terminé le nettoyage d'une plage de données ?",
   "choices":[{"key":"a","text":"La convertir en tableau structuré par Ctrl + L et la nommer"},
              {"key":"b","text":"Appliquer un jeu de couleurs pour distinguer les colonnes"},
              {"key":"c","text":"Ajouter une ligne de total en bas de chaque colonne numérique"}],
   "correct_answer":"a","feedback":"Le tableau structuré étend ses plages seul, nomme ses colonnes et propage ses formules. Deux secondes de coût, et tout ce qui suit en dépend."},
